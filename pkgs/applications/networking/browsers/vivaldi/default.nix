...
, libXfixes, libXt, libXi, libXcursor, libXScrnSaver, libXcomposite, libXdamage, libXtst, libXrandr, libxkbcommon, libxshmfence
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "0ambcpblxdhwdncy09ma9lc91jiw5bzs9yizm0sygmkdpj1g2cgi";
  };
  ...
  buildInputs = [
    ...
    libXi libXft libXcursor libXfixes libXScrnSaver libXcomposite libXdamage libXtst libXrandr libxkbcommon libxshmfence
